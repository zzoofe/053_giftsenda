...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var simplebar__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! simplebar */ \"./node_modules/simplebar/dist/simplebar.esm.js\");\n/* harmony import */ var choices_js_public_assets_scripts_choices_min__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! choices.js/public/assets/scripts/choices.min */ \"./node_modules/choices.js/public/assets/scripts/choices.min.js\");\n/* harmony import */ var choices_js_public_assets_scripts_choices_min__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(choices_js_public_assets_scripts_choices_min__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var js_datepicker__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! js-datepicker */ \"./node_modules/js-datepicker/dist/datepicker.min.js\");\n/* harmony import */ var js_datepicker__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(js_datepicker__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var _js_multSelect__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../js/multSelect */ \"./src/js/multSelect.js\");\n/* harmony import */ var _js_multSelect__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_js_multSelect__WEBPACK_IMPORTED_MODULE_3__);\n/* harmony import */ var micromodal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! micromodal */ \"./node_modules/micromodal/dist/micromodal.es.js\");\n\n\n\n\n\nmicromodal__WEBPACK_IMPORTED_MODULE_4__[\"default\"].init({\n  onShow: function onShow() {\n    return document.body.classList.add('howdy');\n  },\n  onClose: function onClose() {\n    return document.body.classList.remove('howdy');\n  },\n  awaitCloseAnimation: true,\n  openClass: 'open'\n});\nvar choices = document.querySelectorAll(\".js-choice\");\nvar edit = document.querySelectorAll(\".el-edit\");\nvar choicesSearch = document.querySelectorAll(\".js-choice-search\");\nvar choicesTag = document.querySelectorAll(\".js-choice-tag\");\nvar date = document.querySelectorAll(\".inp-date\");\nvar filterTitle = document.querySelectorAll(\".b-filter-box__title span\");\nvar filterBtn = document.querySelector(\".b-filterBtn span\");\nvar filter = document.querySelector(\".b-filter\");\nvar burger = document.querySelector(\".burger\");\nvar tabby = document.querySelector(\".tabby\");\nvar tabs = document.querySelectorAll(\".tab\");\nvar tabContents = document.querySelectorAll(\".tab-content\");\nvar quaPlus = document.querySelector(\".el-qua__btn--plus\");\nvar quaMinus = document.querySelector(\".el-qua__btn--minus\");\nvar countEl = document.querySelector(\".el-qua input\");\nvar imgBtn = document.querySelectorAll(\".b-productDetail__image__small a\");\nvar imgLarge = document.querySelector(\".b-productDetail__image__large img\");\nvar pageBarBtn = document.querySelector(\".b-pageBar__btn\");\nvar pageBar = document.querySelector(\".b-pageBar\");\n\nif (choices) {\n  choices.forEach(function (e) {\n    var choice = new Choices(e, {\n      searchEnabled: false,\n      searchChoices: false,\n      itemSelectText: \"\",\n      callbackOnInit: function callbackOnInit() {\n        var drop = e.attributes[0].ownerElement.parentElement.nextSibling;\n        var scroll = new simplebar__WEBPACK_IMPORTED_MODULE_0__[\"default\"](drop);\n      }\n    });\n  });\n  choicesSearch.forEach(function (e) {\n    var choicesSearch = new Choices(e, {\n      searchEnabled: true,\n      searchChoices: true,\n      itemSelectText: \"\",\n      callbackOnInit: function callbackOnInit() {\n        var drop = e.attributes[0].ownerElement.parentElement.nextSibling;\n        var scroll = new simplebar__WEBPACK_IMPORTED_MODULE_0__[\"default\"](drop);\n      }\n    });\n  });\n  choicesTag.forEach(function (e) {\n    var choicesSearch = new Choices(e, {\n      searchEnabled: true,\n      searchChoices: true,\n      itemSelectText: \"\",\n      removeItemButton: true,\n      callbackOnInit: function callbackOnInit() {\n        var drop = e.attributes[0].ownerElement.parentElement.nextSibling;\n        var scroll = new simplebar__WEBPACK_IMPORTED_MODULE_0__[\"default\"](drop);\n      }\n    });\n  });\n}\n\nif (date) {\n  date.forEach(function (e) {\n    var picker = js_datepicker__WEBPACK_IMPORTED_MODULE_2___default()(e, {\n      formatter: function formatter(input, date, instance) {\n        var value = date.toLocaleDateString(\"en-US\");\n        input.value = value;\n      }\n    });\n  });\n}\n\nif (filterTitle) {\n  var boxOpen = document.querySelector(\".b-filter-box__frame.is-open\");\n  boxOpen.style.maxHeight = boxOpen.scrollHeight + \"px\";\n  filterTitle.forEach(function (e) {\n    e.addEventListener(\"click\", function (e) {\n      e.preventDefault();\n      var el = e.target;\n      var panel = el.parentElement.nextElementSibling;\n      el.classList.toggle(\"is-active\");\n\n      if (panel.style.maxHeight) {\n        panel.style.maxHeight = null;\n\n        if (panel.classList.contains(\"is-open\")) {\n          panel.classList.remove(\"is-open\");\n        }\n      } else {\n        panel.style.maxHeight = panel.scrollHeight + \"px\";\n      }\n    });\n  });\n}\n\nif (filterBtn) {\n  filterBtn.addEventListener(\"click\", function (e) {\n    if (filter.style.maxHeight) {\n      filter.style.maxHeight = null;\n      filter.style.overflow = null;\n    } else {\n      filter.style.maxHeight = filter.scrollHeight + \"px\";\n      setTimeout(function () {\n        return filter.style.overflow = \"visible\";\n      }, 500);\n    }\n  });\n}\n\nif (burger) {\n  burger.addEventListener(\"click\", function (e) {\n    this.classList.toggle(\"open\");\n  });\n}\n\nif (tabs) {\n  tabs.forEach(function (button) {\n    button.addEventListener('click', function (event) {\n      var tabTheme = button.getAttribute('data-theme');\n\n      if (button.classList.contains('is-selected')) {\n        return;\n      } else {\n        tabs.forEach(function (tab) {\n          if (tab.classList.contains('is-selected')) {\n            tab.classList.remove('is-selected');\n          }\n        });\n        button.classList.add('is-selected');\n      }\n\n      tabContents.forEach(function (section) {\n        var contentTheme = section.getAttribute('data-theme');\n\n        if (contentTheme === tabTheme) {\n          section.classList.add('is-selected');\n        } else {\n          section.classList.remove('is-selected');\n        }\n      });\n    });\n  });\n}\n\nif (imgBtn) {\n  imgBtn.forEach(function (e) {\n    e.addEventListener(\"click\", function (e) {\n      imgBtn.forEach(function (e) {\n        console.log(111);\n        e.classList.remove(\"is-active\");\n      });\n      var src = this.getAttribute(\"data-src\");\n      this.classList.add(\"is-active\");\n      imgLarge.setAttribute(\"src\", src);\n    });\n  });\n}\n\nvar count = 1;\n\nif (quaPlus) {\n  quaPlus.addEventListener(\"click\", function (e) {\n    count++;\n    countEl.value = count;\n  });\n}\n\nif (quaMinus) {\n  quaMinus.addEventListener(\"click\", function (e) {\n    if (count > 1) {\n      count--;\n      countEl.value = count;\n    }\n  });\n}\n\nif (edit) {\n  edit.forEach(function (e) {\n    e.addEventListener(\"click\", function (e) {\n      e.preventDefault();\n      var ed = this.parentElement.querySelector(\".text-edit\");\n      ed.setAttribute('contenteditable', 'true');\n      ed.focus(); // console.log(this.parentElement)\n    });\n  });\n}\n\nif (pageBar) {\n  pageBar.addEventListener(\"click\", function (e) {\n    pageBar.classList.toggle(\"is-open\");\n  });\n}\n\n//# sourceURL=webpack:///./src/js/main.js?");

/***/ }),

/***/ "./src/js/multSelect.js":
/*!******************************!*\
  !*** ./src/js/multSelect.js ***!
  \******************************/
/*! no static exports found */
